    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: count == _chosenGoal ? BoxDecoration(
          ...
          border: Border.all(width: 1, color: const Color(0xffE33322))
        ) : BoxDecoration(
            border: Border.all(color: const Color(0xffE33322), width: 1)
        ),
        child: Text(
          title, style: TextStyle(
          fontWeight: FontWeight.bold, fontSize: 20, color: count == _chosenGoal ? Colors.white : Colors.black
        ),
