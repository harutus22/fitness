                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  Container(
                                    ...
                                    child: ClipOval(
                                      child: SizedBox.fromSize(
                                        ...
                                        child: Image.file(File('$item'), height: 80, width: 80, fit: BoxFit.cover,),
                                      ),
                                    ),
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Colors.black, fontFamily: 'Rubik',),
                        )
                      ],
                    ),
                  ),
    ...
    return InkWell(
      onTap: () async {
        if(title == aboutMe.tr()){
          ...
          inAppReview.openStoreListing(appStoreId: '6448538242');
