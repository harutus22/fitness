...
class PlankScreen extends StatefulWidget {
  const PlankScreen({Key? key}) : super(key: key);
...
class _PlankScreenState extends State<PlankScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/female_2.mp4');
      ...
      body: SafeArea(
          child: Column(
            ...
            children: [
              ...
              next(context, highKneesScreen, isNextActive, () {
                user.secondCount = TrainingCount.values[int.parse(_groupValue!)];
                sendEvent("onboarding_12");
              }),
              const SizedBox(height: 20,),
              GestureDetector(
                onTap: () {
                  ...
                  sendEvent("onboarding_12");
                  changeScreen(highKneesScreen, context);
                },
                child: Padding(
