...
class BurpeesScreen extends StatefulWidget {
  const BurpeesScreen({Key? key}) : super(key: key);

  @override
  State<BurpeesScreen> createState() => _BurpeesScreenState();
}

class _BurpeesScreenState extends State<BurpeesScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/male_3.mp4');
