...
class DeepSquatsScreen extends StatefulWidget {
  const DeepSquatsScreen({Key? key}) : super(key: key);

  @override
  State<DeepSquatsScreen> createState() => _DeepSquatsScreenState();
}

class _DeepSquatsScreenState extends State<DeepSquatsScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/female_1.mp4');
  ...
  Widget build(BuildContext context) {
    chooseWidth = MediaQuery.of(context).size.width ;
      ...
      body: SafeArea(
          child: Column(
            ...
            children: [
              ...
              next(context, plankScreen, isNextActive, () {
              ...
              GestureDetector(
                onTap: () {
                  ...
                  sendEvent("onboarding_11");
                  changeScreen(plankScreen, context);
                },
                child: Padding(
