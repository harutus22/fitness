...
class SitUpsScreen extends StatefulWidget {
  const SitUpsScreen({Key? key}) : super(key: key);
...
class _SitUpsScreenState extends State<SitUpsScreen> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/videos/male_2.mp4');
    ...
    return Scaffold(
      body: SafeArea(
          ...
          const SizedBox(height: 10,),
              ...
              next(context, burpeesScreen, isNextActive, () {
              ...
              GestureDetector(
                onTap: () {
                  ...
                  sendEvent("onboarding_12");
                  changeScreen(burpeesScreen, context);
                },
                child: Padding(
