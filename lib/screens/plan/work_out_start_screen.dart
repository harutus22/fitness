...
import 'package:fitness/custom_widgets/video_player_workout.dart';
...
class _WorkoutStartScreenState extends State<WorkoutStartScreen> with SingleTickerProviderStateMixin, WidgetsBindingObserver {
  final CountdownController _controllerTimerTraining =
  CountdownController(autoStart: false);
  var _currentPosition = 0;
  var _totalCount = 50;
  Reference ref = FirebaseStorage.instance.ref();
  late Reference video;
  ...
  Widget build(BuildContext context) {
    ...
    video = ref.child("training_videos").child("${workoutModel.id}.mp4");
                    ...
                    child: AspectRatio(
                      ...
                      child: Stack(
                        ...
                        children: <Widget>[
                          ...
                          //       final url = "${snapshot.data?.path}/training_video/${workoutModel.id}.mp4";
                          //       _isSetVideo = true;
                          //       _controller =
                          ...
                          preCount == true && _isResting == false ? Container(
                            ...
                            child: Center(
                                child: Countdown(
                                  ...
                                  onFinished: (){
                                    preCount = false;
                                    if(currentWork.count > 1000 && isActive)
  ...
  Widget getVideo(WorkOutModel workoutModel){
    ...
    //   return VideoPlayer(_controller);
    // }
    return VideoPlayerWorkout(key: Key("$_currentPosition${workoutModel.name}"),workoutModel: workoutModel, ready: (){
      setState(() {
        _isSetVideo = true;
        _videoReady = true;
      });
